...
import co.edu.uniquindio.billetera_virtual.billetera_virtual_fx.controller.GestionCuentasController;
...
public class GestionCuentasViewController {
            ...
            if (verificarCamposLlenos()) {
                if (verificarCamposCorrectos()) {
                    ...
                    if (gestionCuentasController.actualizarCuenta(cuentaSeleccionada, cuentaNueva)) {
                        ...
                        limpiarSeleccion();
                        tb_cuentas.refresh();
                        mostrarMensaje(TITLE_ACCOUNT_ACTUALIZADA, BODY_ACCOUNT_ACTUALIZADA, Alert.AlertType.INFORMATION);
                    }
                    else {
    ...
    private void mostrarMensajeNoActualizarCuenta(CuentaDto cuenta) {
        ...
        if (gestionCuentasController.verificarCuentaNumCuenta(numCuenta)
            ...
            mostrarMensaje(TITLE_ACCOUNT_NO_ACTUALIZADA, BODY_ACCOUNT_NO_ACTUALIZADA_NUM_CUENTA, Alert.AlertType.ERROR);
        }
    }
