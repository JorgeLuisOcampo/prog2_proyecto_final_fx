...
public class MenuAdminViewController {
    ...
    private void cargarVistaGestionUsuarios() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/co/edu/uniquindio/billetera_virtual/billetera_virtual_fx/GestionUsuarios.fxml"));
    ...
    private void cargarVistaGestionCuentas() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource(
                    "/co/edu/uniquindio/billetera_virtual/billetera_virtual_fx/GestionCuentas.fxml"));
            AnchorPane nuevaVista = loader.load();
